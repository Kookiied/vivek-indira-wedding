    ...
    <section className="relative w-full bg-[#5E0B2B] text-[#FFF0F5] pb-16">
      ...
      <div className="max-w-md mx-auto px-6 text-center pt-6">
        ...
        >
          ...
          <h2 className="font-script text-5xl text-[#F8C8DC] font-bold leading-tight">
            Reveal Our Big Day
          </h2>
          <span className="font-serif text-[11px] italic text-[#FFF0F5]/80 block mt-1 mb-6">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <h2 className="font-script text-4xl text-[#F8C8DC] font-semibold">
